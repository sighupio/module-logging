...
This release adds the support to Kubernetes 1.34, updates MinIO, adds HAProxy ingress controller logging support and improves ingress-nginx log parsing with hostname field extraction..
...
| `minio-ha`              | [`RELEASE.2025-09-07T16-13-09Z``](https://github.com/minio/minio/tree/RELEASE.2025-09-07T16-13-09Z`) | `RELEASE.2025-02-28T09-55-16Z`      |
